...
namespace LearnStructuredProgramming.Section05_ObjectOrientedProgrammingPlus.Domain.Entities
{
  ...
  public sealed class Lizard : Entity
  {
    ...
    private LizardState _state = LizardState.Wandering;
    private Tail? _droppedTail;
    private int _speedBoostTicks;
    private const int SpeedBoostDuration = 10; // 尻尾を落とした後の倍速継続ティック数
    ...
    public bool HasTail => _state == LizardState.Wandering || _state == LizardState.Fleeing;

    /// <summary>現在の状態</summary>
    public LizardState State => _state;

    /// <summary>切り離した尻尾</summary>
    public Tail? DroppedTail => _droppedTail;
    ...
    private void DropTail()
    {
      ...
      _droppedTail = new Tail(tailPosition, GetBounds());
      _state = LizardState.TailDropped;
      _speedBoostTicks = SpeedBoostDuration;
    }
